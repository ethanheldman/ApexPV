  ...
  return (
    <div className="mx-auto max-w-md px-5 pt-10">
      <div className="card p-6">
        ...
        <div className="my-6 flex items-center gap-2 text-stone-400 text-xs">
          ...
          <div className="grid grid-cols-2 gap-2">
            {demo.map((u) => (
              <button
                ...
                disabled={busy}
                className="text-left rounded-xl border border-stone-200 p-3 hover:bg-stone-50 disabled:opacity-50"
              >
                ...
                <div className="text-[11px] text-stone-400 mt-1">@{u.handle}</div>
              </button>
            ))}
          </div>
        )}
